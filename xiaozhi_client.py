...
class VoiceRecorder:
    def __init__(self):
        # INMP441 硬件参数配置
        self.INMP441_sck_pin = Pin(2)    # BCK
        self.INMP441_ws_pin = Pin(3)     # WS/LRC
        self.INMP441_sd_pin = Pin(4)     # DIN
        ...
        # MAX98357 初始化引脚定义
        self.MAX98357_sck_pin = Pin(9)
        self.MAX98357_ws_pin = Pin(8)
        self.MAX98357_sd_pin = Pin(7)
